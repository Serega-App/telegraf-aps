...
//        fragmentView.addView(navigationBar, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 0, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL));
    ...
    private void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        final int telegramBlueTop = 0xFF2AABEE;
        final int telegramBlueBottom = 0xFF229ED9;
        items.add(SettingCell.Factory.of(1, telegramBlueTop, telegramBlueBottom, R.drawable.settings_account, getString(R.string.SettingsAccount), getString(R.string.SettingsAccountInfo)));
        items.add(SettingCell.Factory.of(2, telegramBlueTop, telegramBlueBottom, R.drawable.settings_chat, getString(R.string.SettingsChat), getString(R.string.SettingsChatInfo)));
        items.add(SettingCell.Factory.of(3, telegramBlueTop, telegramBlueBottom, R.drawable.settings_privacy, getString(R.string.SettingsPrivacySecurity), getString(R.string.SettingsPrivacySecurityInfo)));
        items.add(SettingCell.Factory.of(5, telegramBlueTop, telegramBlueBottom, R.drawable.settings_sounds, getString(R.string.SettingsNotifications), getString(R.string.SettingsNotificationsInfo)));
        items.add(SettingCell.Factory.of(6, telegramBlueTop, telegramBlueBottom, R.drawable.settings_data, getString(R.string.SettingsData), getString(R.string.SettingsDataInfo)));
        items.add(SettingCell.Factory.of(7, telegramBlueTop, telegramBlueBottom, R.drawable.settings_folders, getString(R.string.SettingsFolders), getString(R.string.SettingsFoldersInfo)));
        items.add(SettingCell.Factory.of(8, telegramBlueTop, telegramBlueBottom, R.drawable.settings_devices, getString(R.string.SettingsDevices), getString(R.string.SettingsDevicesInfo)));
        items.add(SettingCell.Factory.of(9, telegramBlueTop, telegramBlueBottom, R.drawable.settings_power, getString(R.string.SettingsPowerSaving), getString(R.string.SettingsPowerSavingInfo)));
        items.add(SettingCell.Factory.of(10, telegramBlueTop, telegramBlueBottom, R.drawable.settings_language, getString(R.string.SettingsLanguage), LocaleController.getCurrentLanguageName()));
