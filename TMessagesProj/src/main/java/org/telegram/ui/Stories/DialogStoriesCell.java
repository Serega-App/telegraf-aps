...
public class DialogStoriesCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, FactorAnimator.Target {
    ...
    public DialogStoriesCell(@NonNull Context context, BaseFragment fragment, int currentAccount, int type) {
        ...
        telegramLogoView.setGravity(Gravity.LEFT | Gravity.CENTER_VERTICAL);
        ...
        telegramLogoView.setText("Telegraf");
        ...
        addView(telegramLogoView, LayoutHelper.createFrame(140, 28));
...
//              }
        ...
        if (progress != 0) {
            ...
            telegramLogoView.setTranslationX(titleView.getTranslationX());
            telegramLogoView.setTranslationY(bottomY + dp(15 + FAKE_TOP_PADDING) + translationOffset);

            emojiStatusView.setTranslationX(titleView.getTranslationX() + telegramLogoView.getMeasuredWidth());
    ...
    private void checkUi_titleVisibility() {
        ...
        if (titleView != null) {
            ...
            if (telegramLogoView != null) {
                telegramLogoView.setVisibility(titleAlpha > 0 ? GONE : VISIBLE);
            }
        }
        if (telegramLogoView != null) {
