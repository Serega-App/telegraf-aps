        ...
        if (view instanceof TextView) {
            ...
            if (text != null) {
                ...
                if (value.contains("Telegram")) {
                    textView.setText(value.replace("Telegram", "Telegraf"));
                }
            }
        }
...
//            }
    ...
    public View createView(final Context context) {
        ...
        floatingButtonAi.setImageResource(R.drawable.ic_ai_star);
        floatingButtonAi.setOnClickListener(v -> {
            if (!Browser.openInTelegramBrowser(getParentActivity(), AI_WEB_URL, null)) {
                Browser.openUrl(getParentActivity(), AI_WEB_URL, false);
            }
        });
        ...
        if (hasMainTabs) {
            ...
            actionBar.setTitle("Telegraf");
            actionBar.setTitleColor(0xFF229ED9);
        }
...
//                            ForumUtilities.applyTopic(activity, MessagesStorage.TopicKey.of(-chat.id, getMessagesController().getForumLastTopicId(chat.id)));
    ...
    private void updateFloatingButtonVisibility(boolean animated) {
        ...
        if (floatingButtonAi != null) {
            floatingButtonAi.setButtonVisible(isVisible && !isGuestMode(), animated);
        }
    }
    ...
    private void updateFloatingButtonOffset() {
        ...
        if (floatingButtonAi != null) {
            floatingButtonAi.setTranslationY(baseTranslationY - dp(104));
            floatingButtonAi.setTranslationX(0);
        }
    }
